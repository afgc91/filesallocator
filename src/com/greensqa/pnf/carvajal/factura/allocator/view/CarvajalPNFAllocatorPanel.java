...
public class CarvajalPNFAllocatorPanel extends JPanel {
	...
	/**
	 * Etiqueta para mostrar los archivo de directorios de entrada seleccionado.
	 */
	private JLabel directoriesInLabel;
	
	/**
	 * Etiqueta para mostrar los archivo de directorios de salida seleccionado.
	 */
	...
	private void initializeComponents() {
		...
		//Ajustar componentes.
		directoriesInLabel.setSize(1000, 20);
		directoriesOutLabel.setSize(1000, 20);
	...
	public boolean isValidInput() {
		boolean directoriesInFlag = ! directoriesInLabel.getText().equals(DIR_SELECTED_DEFAULT) && ! directoriesInLabel.getText().equals(directoriesOutLabel.getText());
		...
		return directoriesInFlag && directoriesOutFlag && filesPerDirectoryFlag;
	}
